...
utils.queueMethods = function(name) {
  return function() {
    this.__queue.push({
      method: this['__'+this.__type][name],
      scope: this.__self,
      args: arguments
    });
...
/**
* [queueMachine description]
* @param {[type]} queue [description]
*/
utils.queueMachine = function(queue) {
 ...
 */
utils.each = function(arr, iterator, callback) {
  var completed = 0;
...
utils.getType = function(obj) {
  if(this.__type.call(obj) === '[object Object]') {
    return 'object';
  } else if(this.__callObj(obj) === '[object Function]') {
    return 'function';
  } else {
